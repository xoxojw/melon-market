      ...
      <div className="px-4 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <Link href={`/community/${i}`} className="flex flex-col items-start cursor-pointer">
            ...
            <div className="mt-5 flex items-center justify-between w-full text-gray-500 font-medium test-xs">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
            <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[1.5px] w-full">
              <span className="flex space-x-2 items-center text-sm">
                ...
                <span className="flex space-x-2 items-center text-sm">궁금해요 1</span>
              </span>
              <span className="flex space-x-2 items-center text-sm">
                <svg
                  className="w-4 h-4"
