...
const Profile: NextPage = () => {
  return (
    <Template title="나의 멜론" hasTabBar>
      <div className="px-4">
        ...
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center cursor-pointer">
            <div className="w-14 h-14 text-white bg-melon-500 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
        ...
        <div className="mt-12">
          <div className="flex space-x-3 items-center">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-800 ml-1">니꼬</h4>
